export default function Footer() {
  return (
    <footer className="bg-white dark:bg-black border-t border-gray-200 dark:border-white/10 py-12 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-8 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-8">
            ...
            <a
              href="https://github.com/ThomasFzr" target='_blank' 
              className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-apple"
              aria-label="GitHub"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
